...
export const RSVP_REJECT = "RSVP_REJECT";
export const RSVP_REJECT_SUCCESS = "RSVP_REJECT_SUCCESS";
export const RSVP_REJECT_FAIL = "RSVP_REJECT_FAIL";

export const INVITATION_ACCEPT_REJECT_INITIATED =
  "INVITATION_ACCEPT_REJECT_INITIATED";
export const INVITATION_ACCEPT_REJECT_SUCCESS =
  "INVITATION_ACCEPT_REJECT_SUCCESS";
export const INVITATION_ACCEPT_REJECT_FAIL = "INVITATION_ACCEPT_REJECT_FAIL";
export const CHANGE_GOING_STATUS = "CHANGE_GOING_STATUS";
